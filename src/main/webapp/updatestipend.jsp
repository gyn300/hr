...
<table width="94%"  border="0" align="center" cellpadding="0" cellspacing="1" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" bgcolor="#97B150" >
  ...
  <tr align="center">
    ...
    <td height="27" align="left" bgcolor="#E8FFA7" ><input name="name" type="text" class="input" value=""></td>
    <td height="27" bgcolor="#E8FFA7" >基本薪金：</td>
    <td height="27" align="left" bgcolor="#E8FFA7" ><input name="basic" type="text" class="input" value=""></td>
  </tr>
  <tr align="center">
    <td height="27" bgcolor="#E8FFA7" >饭补：</td>
    <td height="27" align="left" bgcolor="#E8FFA7" ><input name="eat" type="text" class="input" value=""></td>
    <td height="27" bgcolor="#E8FFA7" >房补：</td>
    <td height="27" align="left" bgcolor="#E8FFA7" ><input name="house" type="text" class="input" value=""></td>
  </tr>
  <tr align="center">
    <td height="27" bgcolor="#E8FFA7" >全勤奖：</td>
    <td height="27" align="left" bgcolor="#E8FFA7" ><input name="duty" type="text" class="input" value=""></td>
    <td height="27" bgcolor="#E8FFA7" >赋税：</td>
    <td height="27" align="left" bgcolor="#E8FFA7" ><input name="scot" type="text" class="input" value=""></td>
  </tr>
  <tr align="center">
    <td height="27" bgcolor="#E8FFA7" >额外补助：</td>
    <td height="27" align="left" bgcolor="#E8FFA7" ><input name="other" type="text" class="input" value=""></td>
    <td height="27" align="center" bgcolor="#E8FFA7" >罚款：</td>
    <td height="27" align="left" bgcolor="#E8FFA7" ><input name="punishment" type="text" class="input" value=""></td>
  </tr>
  <tr align="center">
    <td height="27" bgcolor="#E8FFA7" >发放时间：</td>
    <td height="27" colspan="3" align="left" bgcolor="#E8FFA7" ><input name="granttime" type="text" class="input" value=""></td>
  </tr>
  <tr>
