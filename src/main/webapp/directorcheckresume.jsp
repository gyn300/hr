...
<table width="94%"  border="0" align="center" cellpadding="0" cellspacing="1" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" bgcolor="#97B150" >
  <tr>
    <td height="22" colspan="4" align="center" ><strong class="word_yellow">-简历信息-</strong></td>
  </tr>
...
女</td>
  ...
  <form action="/directorEmploy.action">
  <tr>
    <td height="30" colspan="4" align="center" bgcolor="#E8FFA7" ><a href="/directorEmploy.action?user_id=${resume.user_id}&employStatus=1"><input name="employStatus" type="button" class="button" value="录用" ></a>
      &nbsp;&nbsp;
      <a href="/directorEmploy.action?user_id=${resume.user_id}&employStatus=0"><input name="employStatus" type="button" class="button" value="不录用"></a></td>
  </tr>
