...
<script type="text/javascript">
  $(function () {
      ...
      $("#bonuspenalty").click(function () {
          $("#bonuspenaltydiv").css("display","block")
      })
  })
</script>
<body>
...
<table width="94%"  border="0" align="center" cellpadding="0" cellspacing="1" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" bgcolor="#97B150" >
  <tr>
    <td height="22" colspan="4" align="center" ><strong class="word_yellow">-个人信息-</strong></td>
  </tr>
  <tr align="center">
...
女</td>
  ...
  <tr align="center">
    ...
    <td height="22" align="left" bgcolor="#E8FFA7" >
       ${resume.department} &nbsp;${resume.position}
  ...
  <tr align="center">
    ...
    <td height="22" bgcolor="#E8FFA7" >入职时间：</td>
    <td height="22" align="left" bgcolor="#E8FFA7" ><fmt:formatDate value="${employee.inductionTime}" pattern="yyyy-MM-dd"/></td>
  </tr>
  <tr align="center">
  ...
  <tr>
    <td height="30" colspan="4" align="center" bgcolor="#E8FFA7" ><input id="bonuspenalty" type="button" class="button" value="奖惩" >
      &nbsp;&nbsp;
      <input name="Submit2" type="button" class="button" value="返回" onClick="history.back(-1);"></td>
  </tr>
  <tr><td></td><td width="40%" align="center">
  <div id="bonuspenaltydiv" style="display: none">
    <form method="post" action="/insertBonuspenalty.action">
      <table>
    <tr align="center">
    ...
    <tr align="center">
      ...
      <td height="22" align="left" bgcolor="#E8FEA9" ><input name="explains" type="text" class="input"></td>
    </tr>
    <tr align="center">
      <td width="30%" height="22" bgcolor="#E8FEA9" >奖惩金额：</td>
      <td height="22" align="left" bgcolor="#E8FEA9" ><input name="money" type="text" class="input" > </td>
    </tr>
    <tr align="center">
      <td width="30%" height="22" bgcolor="#E8FEA9" >奖惩时间：</td>
      <td height="22" align="left" bgcolor="#E8FEA9" ><input name="time" type="text" class="input" > </td>
    </tr>
      <tr>
        <td style="display: none"><input name="user_id" type="text" value="${employee.user_id}"></td>
      </tr>
    <tr>
