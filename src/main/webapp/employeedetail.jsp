...
<table width="94%"  border="0" align="center" cellpadding="0" cellspacing="1" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" bgcolor="#97B150" >
  ...
  <form id="jobForm" name="jobForm" method="post" action="/updateEmployeeDetail.action"  >
  <tr align="center">
...
女</td>
  ...
  <tr>
    <td height="30" colspan="4" align="center" bgcolor="#E8FFA7" ><input name="submit" type="submit" class="button" value="保存" >
      &nbsp;&nbsp;
      <input name="Submit2" type="button" class="button" value="返回" onClick="history.back(-1);"></td>
  </tr>
  <div style="display: none"><input type="text" name="department" value="${resume.department}"/><input type="text" name="position" value="${resume.position}"/><input type="text" name="experience" value="${resume.experience}"/><input type="text" name="checkStatus" value="${resume.checkStatus}"/><input type="text" name="interviewStatus" value="${resume.interviewStatus}"/></div>
  </form>
</table>		
