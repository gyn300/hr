...
<table width="94%"  border="0" align="center" cellpadding="0" cellspacing="1" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" bgcolor="#97B150" >
  ...
  <tr align="center">
    ...
    <td height="22" align="left" bgcolor="#E8FFA7" ><input name="name" type="text" class="input" value=""></td>
    </tr>
  <tr align="center">
    <td width="30%" height="22" bgcolor="#E8FFA7" >奖惩原因：</td>
    <td height="22" align="left" bgcolor="#E8FFA7" ><input name="reason" type="text" class="input" value=""></td>
    </tr>
  <tr align="center">
    <td width="30%" height="22" bgcolor="#E8FFA7" >奖惩说明：</td>
    <td height="22" align="left" bgcolor="#E8FFA7" ><textarea name="explain" cols="50" rows="6" class="input"></textarea></td>
    </tr>
  <tr>
