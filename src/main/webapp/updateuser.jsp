...
<table width="94%"  border="0" align="center" cellpadding="0" cellspacing="1" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" bgcolor="#97B150" >
  ...
  <tr>
    ...
    <td height="22" colspan="3" align="left" bgcolor="#E8FFA7" ><input name="username" type="text" class="input" value="" readonly="yes">
    （只读）</td>
    </tr>
  <tr>
    <td width="12%" height="22" align="center" bgcolor="#E8FFA7" >是否管理员：</td>
    <td height="22" colspan="3" align="left" bgcolor="#E8FFA7" ><input name="isadminhelp" type="checkbox" onClick="javascript:adminChecked();" value=""></td>
  ...
  <tr>
    ...
    <td height="22" colspan="3" align="left" bgcolor="#E8FFA7" ><input name="sex" type="radio" value="1" >
      男
  ...
  <tr>
    ...
    <td height="22" colspan="3" align="left" bgcolor="#E8FFA7" ><input name="birthday" type="text" class="input" value=""></td>
    </tr>
  <tr>
